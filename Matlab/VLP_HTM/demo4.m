...
% Emitters
n_Emitters = 12;         % Number of emitters
...
% Emitters(1).HTM = Em_Base_HTM*Trans3(0.5,0,0);                            % (2, 1.5, 2)
% Emitters(2).HTM = Em_Base_HTM*Trans3(1,0,0);                              % (2.5, 1.5, 2)
% Emitters(3).HTM = Em_Base_HTM*RotZ3(pi/2)*Trans3(0,0,0);                  % (1.5, 1.5, 2)
% Emitters(4).HTM = Em_Base_HTM*RotZ3(pi/2)*Trans3(0.5,0,0);                % (1.5, 1.5, 2)
% Emitters(5).HTM = Em_Base_HTM*RotZ3(pi/2)*Trans3(1,0,0);                  % (1.5, 0.5, 2)
% Emitters(6).HTM = Em_Base_HTM*RotZ3(pi)*Trans3(0.5,0,0);
% Emitters(7).HTM = Em_Base_HTM*RotZ3(pi)*Trans3(1,0,0);
% Emitters(8).HTM = Em_Base_HTM*RotZ3(3*pi/2)*Trans3(0.5,0,0);
% Emitters(9).HTM = Em_Base_HTM*RotZ3(3*pi/2)*Trans3(1,0,0);
% Emitters(10).HTM = Em_Base_HTM*Trans3(0.5,0.5,0);
% Emitters(11).HTM = Em_Base_HTM*Trans3(0.5,0.5,0);
% Emitters(2).HTM = Em_Base_HTM*RotZ3(pi/2)*Trans3(0.5,0,0);
% Emitters(3).HTM = Em_Base_HTM*RotZ3(pi)*Trans3(0.5,0,0);
% Emitters(4).HTM = Em_Base_HTM*RotZ3(3*pi/2)*Trans3(0.5,0,0);
...
% The sensor is initially placed at point (X,Y) = (0.5,3) IMPORTANT
PDSensor = vlpMoveSensor(PDSensor,Trans3(3,3,0));   
